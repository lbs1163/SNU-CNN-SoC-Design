...
im_2025Spring= imread('output/out_img_2025Spring.bmp');
...
im_2025Spring_crop    = shave(im_2025Spring,[up_scale,up_scale]);
...
[psnr_2025Spring, mae_2025Spring]  = compute_psnr(im_gnd_crop,im_2025Spring_crop);
...
subplot(2,2,4),imshow(im_2025Spring); title(sprintf('2025Spring (%.2f dB) ',psnr_2025Spring));